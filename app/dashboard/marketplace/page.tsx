  ...
  return (
    <div className="flex-1 overflow-auto">
      ...
      <Dialog open={isProfileOpen} onOpenChange={setIsProfileOpen}>
        <DialogContent className="max-w-md bg-[#0d0a1e] border-white/[0.08]">
          <DialogHeader>
          ...
          {viewingProfile && (
            <div className="px-6 pb-6 space-y-6">
              ...
              {/* Social Links */}
              <div className="space-y-3">
                <h4 className="text-sm font-medium text-foreground/60">Connect via</h4>
                <div className="grid gap-2">
                  {viewingProfile.github && (
                    <a
                      ...
                      className="flex items-center gap-3 p-3 rounded-lg border border-white/[0.08] hover:bg-white/[0.05] transition-colors cursor-pointer"
                    >
