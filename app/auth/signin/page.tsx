    ...
    <div className="min-h-screen bg-slate-950 text-white">
      ...
      <div className="flex items-center justify-center px-4 py-12">
        <Card className="w-full max-w-md border-slate-800 bg-slate-950">
          <CardHeader>
            <CardTitle className="text-center text-2xl font-semibold text-white">Sign In to SkillNexus</CardTitle>
          </CardHeader>
        <CardContent className="space-y-4">
          ...
          <div className="text-center">
            <Link href="/auth/signup" className="text-sm text-cyan-500 hover:text-cyan-400 transition-colors">
