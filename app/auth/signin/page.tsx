...
function AuthInput({
  id, label, type = "text", value, onChange, required, placeholder,
}: {
          ...
          <div className="relative rounded-2xl overflow-hidden">
            ...
            <div className="relative px-8 py-9 space-y-5">
              ...
              <div className="text-center space-y-1">
                ...
                <p className="text-sm text-foreground/40">Sign in to your SkillNexus account</p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <AuthInput id="email" label="Email" type="email"
