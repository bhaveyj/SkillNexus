...
export const DesktopSidebar = ({
  ...
  return (
    <>
      <motion.div
        className={cn(
          "hidden h-full w-[300px] flex-shrink-0 bg-card border-r border-border px-4 py-4 md:flex md:flex-col",
          className
        )}
        animate={{
...
export const MobileSidebar = ({
  ...
  return (
    <>
      <div
        className={cn(
          "flex h-10 w-full flex-row items-center justify-between bg-card px-4 py-4 md:hidden"
        )}
        {...props}
      >
